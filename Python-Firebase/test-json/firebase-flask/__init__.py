...
cred = credentials.Certificate("firebase-flask/capstone-da813-firebase-adminsdk-sfdae-2d1ad8cb02.json")
...
def get_restricted(sentence):
    ...
    with open('firebase-flask/restricted_subjects.csv', newline='', encoding='UTF-8') as f2:
...
def listener(event):
    ...
    with open('firebase-flask/data.json', 'r', encoding='utf-8') as f1:
    ...
    # stt로 받은 텍스트로 추천 뽑기
    df = pd.read_csv('firebase-flask/test_class_final.csv', encoding='utf-8')
